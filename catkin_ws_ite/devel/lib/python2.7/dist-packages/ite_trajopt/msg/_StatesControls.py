...
"""autogenerated by genpy from ite_trajopt/StatesControls.msg. Do not edit."""
import sys
...
class StatesControls(genpy.Message):
  _md5sum = "406d66282d3640a0cf3e1d5ea7de169a"
  _type = "ite_trajopt/StatesControls"
...
uint32 stride  # stride of given dimension"""
  __slots__ = ['header','X','U']
  _slot_types = ['std_msgs/Header','std_msgs/Float32MultiArray[]','std_msgs/Float32MultiArray[]']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(StatesControls, self).__init__(*args, **kwds)
