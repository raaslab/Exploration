...
if("FALSE" STREQUAL "TRUE")
  set(roboclaw_SOURCE_PREFIX /home/aravind/catkin_ws_ite/src/scarab/roboclaw)
  set(roboclaw_DEVEL_PREFIX /home/aravind/catkin_ws_ite/devel)
  set(roboclaw_INSTALL_PREFIX "")
  set(roboclaw_PREFIX ${roboclaw_DEVEL_PREFIX})
else()
  set(roboclaw_SOURCE_PREFIX "")
  set(roboclaw_DEVEL_PREFIX "")
  set(roboclaw_INSTALL_PREFIX /home/aravind/catkin_ws_ite/install)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'roboclaw' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/aravind/catkin_ws_ite/install/${idir}'.  Ask the maintainer 'bcharrow <bcharrow@seas.upenn.edu>' to fix it.")
    endif()
